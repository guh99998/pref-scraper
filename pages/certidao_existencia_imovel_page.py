...
class CertidaoDeExistenciaPage:
    ...
    def gerar_pdf_certidao_existencia_imovel(self):

        imovel = self.driver.dados_imovel
        nome_arquivo = f"{imovel['bairro']}_{imovel['quadra']}_{imovel['lote']} - certidao_existencia.pdf"

        esperar_elemento_visivel(self.driver, By.ID, ID_BOTAO_CERTIDAO_EXISTENCIA).click()
